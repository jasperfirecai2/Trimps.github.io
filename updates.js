...
function getBattleStatBd(what) {
	...
	if (what == "health" || what == "attack"){
		...
		if (autoBattle.oneTimers.Suprism.owned){
			...
			currentCalc += bonus;
			textString += "<tr><td class='bdTitle'>Suprism</td><td>3%</td><td>" + (autoBattle.getMaxEnemyBeaten()) + "</td><td>" + prettify(bonus * 100) + "%</td><td>" + Math.round(currentCalc * 100) + "%</td></tr>";
		}
	...
	if ((what == "attack" || what == "health") && getPerkLevel("Championism")){
		...
		currentCalc  *= mult;
		textString += "<tr><td class='bdTitle'>Championism</td><td>" + (1 + (0.5 * (autoBattle.getMaxEnemyBeaten()))) + "%</td><td>" + getPerkLevel("Championism") + "</td><td>" + formatMultAsPercent(mult) + "</td><td class='bdNumberSm'>" + prettify(currentCalc) + "</td>" + ((what == "attack") ? getFluctuation(currentCalc, minFluct, maxFluct) : "") + "</tr>";
	}
	if (what == "attack" && Fluffy.isRewardActive('SADailies') && game.global.challengeActive == "Daily"){
		...
		currentCalc *= mult;
		textString += "<tr><td class='bdTitle'>Scruffy Dailies</td><td>+ 4%</td><td>" + (autoBattle.getMaxEnemyBeaten()) + "</td><td>+ " + prettify((mult - 1) * 100) + "%</td><td class='bdNumberSm'>" + prettify(currentCalc) + "</td>" + getFluctuation(currentCalc, minFluct, maxFluct) + "</tr>"
	}
